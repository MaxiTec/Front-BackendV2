...
const Paginator = ({ pagination, pages, onSelect }) => (
  <div className='pagination'>
    ...
    >
      <Pagify.Button page={pagination.page - 1}><i className='fa fa-angle-left' /></Pagify.Button>
      ...
      <Pagify.Button page={pagination.page + 1}><i className='fa fa-angle-right' /></Pagify.Button>
    </Pagify.Context>
  </div>
)
Paginator.propTypes = {
