...
const MyMenu =()=> (
        ...
        <SubMenu key="sub1" title={<span className="menu__subtitle"><span className="fa fa-building-o fa-fw fa-2x"></span><span>Hoteles</span></span>}>
        ...
        <SubMenu key="sub2" title={<span className="menu__subtitle"><span className="fa fa-facebook fa-fw fa-2x"></span><span>Hoteles</span></span>}>
